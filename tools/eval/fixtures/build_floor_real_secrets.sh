...
OUT="$HERE/repos/floor-real-secrets"
SRC="$HERE/src/real-secrets"
rm -rf "$OUT"
...
git -C "$OUT" add .
GIT_AUTHOR_DATE=2026-01-01T00:00:01Z GIT_COMMITTER_DATE=2026-01-01T00:00:01Z git -C "$OUT" commit -q -m "real secrets seeds"
